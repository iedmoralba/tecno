...
let sapa = document.getElementById('sapa');
...
let ejer=['CA-SA','CA-MA','CA-JA','GA-TA','HA-DA','LA-TA','LLA-MA','MA-SA','PA-LA','SA-LA','SA-PA','VA-CA'];
//let ejer=['CA-SA','CA-MA'];
let imagen=document.getElementById('imagen');
let gsilabas=document.getElementById('g_silabas');
let silabas=gsilabas.querySelectorAll('.silaba');
