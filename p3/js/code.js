...
let btn_mayus = document.getElementById("btn_mayus");
//
//////
...
//let ejer=['YA-TE','LLA-VE','TE-LA','LE-ÑA','YE-MA','ME-SA','MA-DE-RA','MA-LE-TA','PA-LE-TA','ME-DA-LLA','TA-PE-TE','CA-FÉ','BE-BÉ'];
let ejer = ['CA-SA','CA-MA','CA-JA','GA-TA','HA-DA','LA-TA','LLA-MA','MA-SA','PA-LA','SA-LA','RA-NA','VA-CA','YA-TE','LLA-VE','TE-LA','LE-ÑA','YE-MA','ME-SA','MA-DE-RA','MA-LE-TA','PA-LE-TA','ME-DA-LLA','TA-PE-TE','CA-FÉ','BE-BÉ'];
//let ejer = ['CA-FÉ'];
...
function agregarEventos(){
	...
	btn_play2.addEventListener('click',function(){
		...
		ractiva=u;
		let t=u.toLowerCase();
		let obj=document.getElementById("a"+t);
	...
	btn_mayus.addEventListener('click',function(){
...
function mostrarImagen(){
	...
	if(obj){
		...
		let sonido = document.getElementById('a'+t);
		sonido.play();
...
function mostrarCombinaciones(){
	...
	silabas.forEach(function(item,index){
		let txt = r[index];
		if(btn_mayus.letra==="minuscula"){txt=txt.toLowerCase();}
